package com.shoumei.xhn.widget.utils
...
class OverlayViewUtils {
    ...
    private fun getView(context: Context, viewType: Int): View? {
        ...
        val view = when (viewType) {
            loading -> View.inflate(context, R.layout.layout_loading, null)
            networkError -> View.inflate(context, R.layout.layout_net_error, null).apply {}
            else -> null
        }
        view?.let {
