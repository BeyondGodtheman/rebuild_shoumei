package com.coco_sh.shmstore.home.widget
...
import com.coco_sh.shmstore.home.view.BonusMoneyFragment
import com.coco_sh.shmstore.home.view.WeatherFragment
...
//       initPhotoFragment()
    ...
    class PageAdapter(private val fragment: ArrayList<Fragment>, fm: FragmentManager) : FragmentStatePagerAdapter(fm) {
